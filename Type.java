...
{ private Vector values; // null except for enumerations
  ...
  { // recusively finds similarity of tsrc, ttrg
    ...
    { return ModelMatching.BOOLENUM*t2.enumBooleanSimilarity(); } 
    ...
    { Type et2 = t2.getElementType(); 
      return ModelMatching.ONESET*Type.typeSimilarity(t1,et2,mm,entities); 
    } 
  ...
  { String res = "  helper def : " + name + "2String(_v : " + name + ") : String =\n" + 
      "    " + enumcases2StringATL() + "; \n\n" + 
      "  helper def : String2" + name + "(_v : String) : " + name + " =\n" + 
      "    " + enumcases2EnumATL() + ";\n\n"; 
    return res; 
  } 
  ...
  { Vector values1 = e1.getValues(); 
    ...
    return (1.0*s)/Math.max(s1,s2) + namesim; 
  } 
