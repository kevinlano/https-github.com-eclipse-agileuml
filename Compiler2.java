...
{ static final int INUNKNOWN = 0; 
  ...
  { if (str.equals("class") || str.equals("if") || str.equals("while") ||
        ...
        str.equals("boolean") || str.equals("int") || str.equals("long") || 
  ...
  { boolean res = true; 
    if (Character.isLetter(s.charAt(0)) || s.charAt(0) == '#') { } else { return false; }   
  ...
  { if (st > en) { return null; } 
    ...
    { // System.out.println("Creating new basic type");
  ...
  { boolean abstr = false; 
    ...
    { String lx2 = lexicals.get(i) + ""; 
      ...
      { String lxr = lexicals.get(reached) + ""; 
        if ("attribute".equals(lxr) || "reference".equals(lxr) || 
      ...
      { String scope = lexicals.get(i-1) + ""; // must be present, can be void
        ...
        { if (":".equals(lexicals.get(j) + "") && ":".equals(lexicals.get(j+1) + ""))
          ...
          { Expression ff = parse_expression(0, i+2, j); 
            System.out.println(">>>> Parsed postcondition " + ff); 
      ...
      { String tt = lexicals.get(i+1) + ""; 
        ...
        { String lx = lexicals.get(j) + ""; 
          ...
          { if ("*".equals(lexicals.get(j+1) + ""))
            ...
            else if ("0".equals(lexicals.get(j+1) + ""))
...
{ if ("using".equals(lexicals.get(st) + "")) {}
  ...
  { String sts = lexicals.get(st) + "";
    ...
    { String wlex = lexicals.get(w) + ""; 
      ...
      { // key eId { attname } ; 
        ...
        if (ent == null) 
        { System.err.println(">>> No entity exists with name: " + eId); 
          st = w+4;
          start = w+6;  
          break; 
        }  
  ...
  { String sts = lexicals.get(st) + "";
    ...
    { String istr = lexicals.get(i) + ""; 
      if ("checkonly".equals(istr) || "enforce".equals(istr) || "primitive".equals(istr))
      { domstart = i; 
        break; 
      } 
    } 
  ...
  { // System.out.println(Double.MAX_VALUE); 
    ...
    c.nospacelexicalanalysis("Map(Map(String,int),Map(String,Sequence(String)))"); 
    Type t = c.parseType(); 
